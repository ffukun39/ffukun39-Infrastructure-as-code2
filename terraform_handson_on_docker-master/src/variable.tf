...
variable "vpc_name" {
  type        = string
  default     = "terraform_fukuoka_on_docker_vpc"
  description = "VPCの名前"
}
...
variable "public_subnet_1c_name" {
  type        = string
  default     = "public_subnet_1c"
  description = "パブリックサブネットの名前"
}

variable "praivate_subnet_1c_name" {
  type        = string
  default     = "praivate_subnet_1c"
...
variable "igw_name" {
  type        = string
  default     = "terraform_fukuoka_on_docker_igw"
  description = "インターネットゲートウェイの名前"
}

variable "route_table_name" {
  type        = string
  default     = "terraform_fukuoka_on_docker_route_table"
...
variable "sg_name" {
  type        = string
  default     = "terraform_fukuoka_on_docker_sg"
...
variable "instance_name" {
  type        = string
  default     = "terraform_fukuoka_on_docker_ec2"
